    ...
    <div class="container-aashi">
        <div class="row site-footer__main align-items-start">
            ...
            <div class="col-12 col-xl-4 site-footer__brand">
                <a href="{{ route('home') }}" class="site-footer__logo d-inline-block">
                    <img src="{{ asset('frontend/assets/images/logo-white.png') }}" alt="Aashi Venture Pvt. Ltd.">
                </a>
                ...
                <div class="site-footer__social">
                    ...
                    <a href="#" aria-label="LinkedIn">
                        <img src="{{ asset('frontend/assets/icons/linkedin.svg') }}" alt="">
                    </a>
                    ...
                    <a href="#" aria-label="YouTube">
                        <img src="{{ asset('frontend/assets/icons/youtube.svg') }}" alt="">
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-xl-8">
                <div class="row site-footer__nav-row">
                    ...
                    <div class="col-sm-6 col-lg-4 site-footer__col">
                        ...
                        <ul class="footer-col__list">
                            <li><a href="{{ route('products.rainwear') }}">Rain Wear Collection</a></li>
                            <li><a href="{{ route('products.winter') }}">Winter Wear Collection</a></li>
                            <li><a href="{{ route('products.windcheaters') }}">Windcheaters Collection</a></li>
                            <li><a href="{{ route('products.bags') }}">Bags Collection</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 site-footer__col site-footer__col--contact">
                        ...
                        <div class="site-footer__contacts">
                            ...
                            {{-- Phone Numbers --}}
                            @if(!empty($setting?->phone_numbers))
                                @foreach(explode(',', $setting->phone_numbers) as $phone)

                                    @php
                                        $phone = trim($phone);
                                        $telPhone = preg_replace('/[^0-9+]/', '', $phone);
                                    @endphp

                                    @if(!empty($phone))
                                        <div class="footer-col__contact">
                                            <img src="{{ asset('frontend/assets/icons/phone.svg') }}" alt="">
                                            <a href="tel:{{ $telPhone }}">{{ $phone }}</a>
                                        </div>
                                    @endif
                            ...
                            @if(!empty($setting?->emails))
                                @foreach(explode(',', $setting->emails) as $email)
                                    ...
                                    @if(!empty($email))
                                        <div class="footer-col__contact">
                                            <img src="{{ asset('frontend/assets/icons/email-white.svg') }}" alt="">
                            ...
                            @if(!empty($setting?->address))
                                <div class="footer-col__contact">
                                    <img src="{{ asset('frontend/assets/icons/location.svg') }}" alt="">
                                    <span>
                                        {{ $setting->address }}
                                    </span>
                                </div>
